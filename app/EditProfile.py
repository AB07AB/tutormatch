...
class EditProfileScreen(tk.Frame):
    def __init__(self, container, user_data):
        ...
        self.font_special = tkfont.Font(family="Inter 18pt", size=6) 
    ...
    def create_form_fields(self):
        ...
        for key, value in fields:
            tk.Label(self, font=self.font_special, bg="white", fg="#5b6779").grid(
                row=1, column=1, columnspan=2, sticky="w", pady=(1, 0)
            )

            entry = tk.Entry(self, width=40, font=self.font_text, bd=1, relief="solid")
            entry.grid(row=row_index, column=1, columnspan=2, pady=(0, 1), sticky="we", padx=(10, 10))
